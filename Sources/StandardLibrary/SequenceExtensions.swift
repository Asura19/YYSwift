...
public extension Sequence {
    ...
    /// YYSwift: Check if no elements in collection match a conditon.
    ///
    ...
    /// YYSwift: Check if any element in collection match a conditon.
    ///
    ...
    func delete(where condition: (Element) throws -> Bool) rethrows -> [Element] {
    ...
    /// YYSwift: Calls the given closure with each element where condition is true.
    ///
    ...
    /// YYSwift: Reduces an array while returning each interim combination.
    ///
    ...
    /// YYSwift: Filtered and map in a single operation.
    ///
    ...
    /// YYSwift: Get the only element based on a condition.
    ///
...
public extension Sequence where Element: Hashable {
    ...
    /// YYSwift: Check whether a sequence contains duplicates.
    ///
