...
public extension Array {
    ...
    mutating func insert(elements: [Element], at index: Int) {
        var i = index
    ...
    func group(by stepSize: Int) -> [[Element]]? {
    ...
    func groupByKey<Key: Hashable>(keyForValue: (_ element: Element) throws -> Key) rethrows -> [Key: [Element]] {
