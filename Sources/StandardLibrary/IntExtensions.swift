...
public extension Int {
    ...
    /// YYSwift: Random integer between two integer values.
    ///
    /// - Parameters:
    ...
    /// YYSwift: Random integer in a closed interval range.
    ///
...
public extension Int {
    ...
    /// YYSwift: Created a random integer between two integer values.
    ///
    /// - Parameters:
    ///   - min: minimum number to start random from.
    ///   - max: maximum number random number end before.
    ...
    /// YYSwift: Create a random integer in a closed interval range.
    ///
    /// - Parameter range: closed interval range.
